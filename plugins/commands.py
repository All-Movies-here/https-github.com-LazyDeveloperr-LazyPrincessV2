...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Support ⚡', url=f"https://t.me/moviesSupportgroup"),
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/+_xOWQxpIfJ4wZDZl')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Updates', url='https://t.me/+_xOWQxpIfJ4wZDZl')],
        [InlineKeyboardButton('Movies', url='https://t.me/+Jawbq9y7rZYzOGZl')],
        [InlineKeyboardButton('Support', url='https://t.me/moviesSupportgroup')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
